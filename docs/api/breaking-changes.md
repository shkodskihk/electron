...
Breaking changes will be documented here, and deprecation warnings added to JS code where possible, at least [one major version](../organizational/electron-versioning.md#semver) before the change is made.
